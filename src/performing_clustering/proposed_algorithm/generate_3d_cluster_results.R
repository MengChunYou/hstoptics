...
parameters_df <- read_parameters(combination_order=2, dim=3)
parameter_order <- 1
for (i in 1:3) {
  for (j in 1:3) {
...
parameters_df <- read_parameters(combination_order=3, dim=3)
parameter_order <- 1
for (i in 1:3) {
  for (j in 1:3) {
    parameter_order <- parameter_order + 1
...
parameters_df <- read_parameters(combination_order=4, dim=3)
parameter_order <- 1
for (i in 1:3) {
  for (j in 1:3) {
    parameter_order <- parameter_order + 1
...
parameters_df <- read_parameters(combination_order=5, dim=3)
parameter_order <- 1
for (i in 1:3) {
  for (j in 1:3) {
    parameter_order <- parameter_order + 1
...
parameters_df <- read_parameters(combination_order=6, dim=3)
parameter_order <- 1
for (i in 1:3) {
  for (j in 1:3) {
    parameter_order <- parameter_order + 1
...
parameters_df <- read_parameters(combination_order=7, dim=3)
parameter_order <- 1
for (i in 1:3) {
  for (j in 1:3) {
    parameter_order <- parameter_order + 1
